...
import org.candy.updater.controller.UpdaterController;
...
import org.candy.updater.misc.PermissionsUtils;
...
import org.candy.updater.model.UpdateStatus;
...
public class UpdatesListAdapter extends RecyclerView.Adapter<UpdatesListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
        ...
        String buildDateTime = StringGenerator.getDateTimeLocalizedUTC(mActivity,
                update.getTimestamp());
        String buildVersion = mActivity.getString(R.string.list_build_version,
                update.getVersion());
        if(update.getVersion().isEmpty()) buildVersion = update.getName();
        viewHolder.mBuildDate.setText(buildDateTime);
